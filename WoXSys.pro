...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/curl/ -lcurl
win32:LIBS += -luser32
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/curl/ -lcurld
else:unix: LIBS += -L$$PWD/curl/ -lcurl
DEFINES += CURL_STATICLIB

INCLUDEPATH += $$PWD/curl
DEPENDPATH += $$PWD/curl

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/curl/ -llibcurl.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/curl/ -llibcurl.dlld
...
win32:CONFIG(release, debug|release): LIBS += -LD:/Qt/Tools/OpenSSL/Win_x86/lib/ -llibcrypto
else:win32:CONFIG(debug, debug|release): LIBS += -LD:/Qt/Tools/OpenSSL/Win_x86/lib/ -llibcryptod
else:unix: LIBS += -LD:/Qt/Tools/OpenSSL/Win_x86/lib/ -llibcrypto

INCLUDEPATH += D:/Qt/Tools/OpenSSL/Win_x86/include
DEPENDPATH += D:/Qt/Tools/OpenSSL/Win_x86/include

win32:CONFIG(release, debug|release): LIBS += -LD:/Qt/Tools/OpenSSL/Win_x64/lib/ -llibcrypto
else:win32:CONFIG(debug, debug|release): LIBS += -LD:/Qt/Tools/OpenSSL/Win_x64/lib/ -llibcryptod
else:unix: LIBS += -LD:/Qt/Tools/OpenSSL/Win_x64/lib/ -llibcrypto

INCLUDEPATH += D:/Qt/Tools/OpenSSL/Win_x64/include
DEPENDPATH += D:/Qt/Tools/OpenSSL/Win_x64/include

unix|win32: LIBS += -llibcrypto
